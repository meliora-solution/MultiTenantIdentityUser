...
namespace AuthpServices.SupportCode.AddUserServices
{
    public class CreateTenant
    {
        ...
        public CreateTenant(IAuthPDefaultLocalizer localizeProvider, IAuthTenantAdminService tenantAdmin,
                                     IAddNewUserManager addNewUserManager, AuthPermissionsOptions options,
                                      ILogger<CreateTenant> logger, AuthPermissionsDbContext context, IGetDatabaseForNewTenant getShardingDb = null)
        {
