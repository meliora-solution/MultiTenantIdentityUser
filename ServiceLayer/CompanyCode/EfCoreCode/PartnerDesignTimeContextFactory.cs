...
{
    public class PartnerDesignTimeContextFactory : IDesignTimeDbContextFactory<PartnerDbContext>          
    {
        ...
        {
            var optionsBuilder =                              
                new DbContextOptionsBuilder<PartnerDbContext>(); 
            optionsBuilder.UseSqlServer(connectionString, dbOptions =>
                dbOptions.MigrationsHistoryTable(StartupExtensions.PartnersDbContextHistoryName));    

            return new PartnerDbContext(optionsBuilder.Options, null); 
        }
    }
    /******************************************************************************
    * NOTES ON MIGRATION:
