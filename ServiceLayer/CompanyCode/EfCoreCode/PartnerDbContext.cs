...
{
    public class PartnerDbContext : DbContext, IDataKeyFilterReadOnly
    {
        public string DataKey { get; }

        public PartnerDbContext(DbContextOptions<PartnerDbContext> options, IGetDataKeyFromUser dataKeyFilter)
            : base(options)
        {
